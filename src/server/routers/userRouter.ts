...
export const userRouter = router({
  ...
  rateUser: publicProcedure
    .input(z.object({ newRating: z.number(), userId: z.string() }))
  ...
  ratingById: publicProcedure
    .input(z.string())
    .query(async ({ input }) => await prisma.rating.findUnique({ where: { userId: input } })),
